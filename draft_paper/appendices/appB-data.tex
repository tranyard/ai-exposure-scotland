...
\small
\input{tables/crosswalk_aggregation_sensitivity}
...
%\small
%\input{tables/industry_invariance_summary}
%\begin{minipage}{0.92\textwidth}
%\vspace{0.4em}\footnotesize
...
\small
\input{tables/industry_contributions}
\begin{minipage}{0.92\textwidth}
\vspace{0.4em}\footnotesize
